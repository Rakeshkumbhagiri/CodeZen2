            ...
            <div className="relative" ref={dropdownRef}>
              ...
              {dropdownOpen && (
                <div className="absolute right-0 z-50 mt-2 animate-fadeIn">
                  ...
                  {/* Dropdown Box */}
                  <div className="overflow-hidden text-black border shadow-2xl w-44 backdrop-blur-xl bg-white/70 border-white/20 rounded-xl">
                    {/* Profile */}
                    <button
                      onClick={() => {
                        setDropdownOpen(false);
                    ...
                    {/* Divider */}
                    <div className="h-px mx-2 bg-gray-300/50"></div>

                    {/* Logout */}
                    <button
                      onClick={handleLogout}
                      className="flex items-center w-full gap-2 px-4 py-3 text-red-400 transition-all duration-200 hover:bg-red-200/70 hover:translate-x-1"
                    >
                      <span>Logout</span>
                    </button>
                  </div>
