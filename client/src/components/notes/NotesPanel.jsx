...
//   // Auto-save
//   useEffect(() => {
//     if (debouncedContent !== getNote(problemId)) {
//       setSaveStatus('saving');
//       saveNote(problemId, debouncedContent);
...
// ✅ localStorage helpers (no Zustand needed)
...
const NotesPanel = ({ problemId, problemTitle }) => {
  ...
  // ✅ Auto-save (debounce without hook)
  useEffect(() => {
  ...
  // Load note when problem changes
  useEffect(() => {
    setContent(getNote(problemId));
    setSaveStatus('saved');
  }, [problemId]);
